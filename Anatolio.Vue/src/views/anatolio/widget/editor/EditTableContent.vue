        ...
        <div class="col-span-12" v-for="(col, index) in content.dataContent.columns" :key="index">
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-6">
                    ...
                    <FormField label="Value Column">
                        <InputGroup>
                            ...
                            <Select v-model="col.name" optionValue="name" optionLabel="name" :options="content.query?.queryColumns??[]" />
                ...
                <div class="col-span-2 text-center mt-5">
                    <Button @click="deleteColumn(index)" class="p-button-danger" text
                            icon="pi pi-trash" />
                </div>
            </div>
        </div>
